...
class DattoDevice {
    ...
    static getAllDevices() {
        ...
        return new Promise(async resolve => {
            ...
            const res = await DattoAPI.get('/account/devices')

            let devicesArrayJSON = res.devices
            // console.log(res)
            ...
            if(res.pageDetails.nextPageUrl !== null) {
                ...
                while(morePages === true) {
                    ...
                    devicesArrayJSON.push(...nextPageResults.devices)
